...
Getting access to the data was an arguably complicated process in the past. I have been granted access to the data three times over the past decade.
The first and second time that I got access to the SCB data was by writing a policy report for the Expertgruppen för Studier i Offentlig ekonomi (ESO, Expert Group on Public Economics). For this, we wrote a research proposal, which was subsequently granted. Noted that I also wrote another unsuccessful proposal a few years later. 
